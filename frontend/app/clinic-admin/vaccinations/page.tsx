...
function SpeciesBadge({ species }: { species: string[] }) {
  ...
  const display = isBoth
    ...
    : species.map((s) => ({
        ...
        cls: s === 'dog' ? 'bg-[#FFF5CB] text-[#DD9730]' : s === 'cat' ? 'bg-purple-100 text-purple-700' : 'bg-teal-100 text-teal-700',
      }))
  return (
                  ...
                  {filtered.map((v) => (
                    ...
                    >
                      ...
                      <div className="md:hidden p-4">
                        ...
                        {v.nextDueDate && <p className="text-xs text-[#DD9730] font-medium mt-0.5">Booster Due: {formatDate(v.nextDueDate)}</p>}
                      </div>
                      ...
                      <div className="hidden md:grid grid-cols-[40px_1fr_1fr_140px_140px_140px_120px] gap-4 items-center px-5 py-3.5">
                        ...
                        <p className="text-xs text-[#DD9730] font-medium">{v.nextDueDate ? formatDate(v.nextDueDate) : '—'}</p>
