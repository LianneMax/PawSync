...
export default function ClinicMedicalRecordsPage() {
  ...
  const fetchRecords = useCallback(async () => {
    ...
    setLoading(true)
    try {
      const res = await getVetMedicalRecords({ limit: 100 }, token)
  ...
  function getVetName(record: MedicalRecord) {
          ...
          <div className="space-y-3">
            {records.map((rec) => (
              <div
                ...
                onClick={() => router.push(`/clinic-admin/medical-records/new?edit=${rec._id}`)}
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex-1 min-w-0 px-4">
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      ...
                      {!hasVitals(rec) && (
                        <span className="text-xs text-orange-500">No vitals</span>
                      )}
                    </div>
                  </div>
