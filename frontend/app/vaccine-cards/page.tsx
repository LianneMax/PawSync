    ...
    <DashboardLayout notificationCount={12}>
      <div className="p-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Vaccine Cards</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-full">
            <div className="bg-white rounded-2xl p-12 shadow-sm text-center border-2 border-dashed border-gray-200">
              ...
              <h2 className="text-2xl font-semibold text-gray-700 mb-2">No vaccine cards yet</h2>
              ...
              <div className="flex gap-4 justify-center">
                ...
                <button className="bg-gray-100 text-gray-700 px-8 py-3 rounded-xl hover:bg-gray-200 transition-colors inline-flex items-center gap-2">
